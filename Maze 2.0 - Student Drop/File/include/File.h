...
public:
   ...
   static FileError write( FileHandle fh, const void * const buffer, const DWORD inSize );
   static FileError read( FileHandle fh, void * const _buffer, const DWORD _size );
